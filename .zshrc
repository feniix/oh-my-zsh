...
plugins=(git git-flow debian ruby python rvm svn pip ssh-agent vagrant github gem command-not-found ant history-substring-search gnu-utils mvn knife zsh-syntax-highlighting urltools vundle sublime)
